...
class DPN:  #ANN with Pytorch
    def __init__(self, env):
        ...
        self.pos_act = ["R", "R'", "U", "U'", "L", "L'", "D", "D'", "F", "F'", "B", "B'"]
        self.n_outputs = len(self.pos_act)
    ...
    def train(self, ITERATIONS):
       ...
       #this would be a list of starting states
    ...
    def trajectory(self, current_state):
        ...
        while True:
            ...
            new_state, reward = self.env.state_and_reward(current_state, self.pos_act[picked_action]) #Get the reward and the new state that the action in the environment resulted in. None if action caused death. TODO build in environment
    ...
    def train_on_jobs(self,jobset, optimizer):
        ...
        for job_start in range(101):
            ...
            state_observed = cube_evn
            episode_array = [self.trajectory(state_observed) for x in range(EPISODES)]
